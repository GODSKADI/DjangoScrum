    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField(blank=True, default='Nou Projecte', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dificultat', models.CharField(choices=[('D', 'Desconocido'), ('B', 'Baja'), ('M', 'Media'), ('A', 'Alta')], default='D', max_length=1)),
                ...
                ('projecte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Project')),
            ],
        ),
        migrations.CreateModel(
            name='Sprint',
